...
# 2022 CC SJ92 - the january peak is intense enough to be considered the "first peak" - might have to switch to discovering maximum peak?
# 2022 CC SV91 - no peak
year <-  2022
species <- "CC"
grid_ref_in <- "SJ92"
...
square_size <-  10000
n_threshold <- 1
file_path <- "data_in/RENEW_extract.csv"
...
bird <- read_csv("data_temp/chiffchaff_2022_10km.csv")
bird <- bird %>% 
